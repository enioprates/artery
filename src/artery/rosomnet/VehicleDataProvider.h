...
class VehicleDataProvider
{
	...
	private:
		...
		//void RXNetCallback(const ros_its_msgs::platoon_dist &msg);
		//void RXNetCallback(const ros_its_msgs::CAM_simplified &msg);
		//void RXNetCallback(const rosgraph_msgs::Clock &msg);
		string car_name;
		double ros_latitude;
