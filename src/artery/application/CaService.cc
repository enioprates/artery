...
vanetza::asn1::Cam createCooperativeAwarenessMessage(const VehicleDataProvider& vdp, uint16_t genDeltaTime)
{
	...
	EV_WARN << "vdp.station_id:"<< vdp.station_id() << std::endl;
	...
	//EV_WARN << "CAM CREATION" << std::endl;
	//EV_WARN << "vdp pointer:"<< (void*)&vdp << std::endl;
	...
	//EV_WARN << "vdp.long:"<< vdp.longitude().value() << std::endl;
	//EV_WARN << "cam.long:"<< basic.referencePosition.longitude << std::endl;
